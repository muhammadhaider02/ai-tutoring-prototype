          ...
          <div className="quiz-container">
            <div className="quiz-question">
              ...
              <div className="correct-answer" style={{ marginTop: '0.5rem', color: '#22c55e', fontStyle: 'italic' }}>
                Correct Answer: B) Arrange the values in order and select the middle one
              </div>
            </div>
            ...
            <div className="quiz-question">
              ...
              <div className="correct-answer" style={{ marginTop: '0.5rem', color: '#22c55e', fontStyle: 'italic' }}>
                Correct Answer: B) The height is the volume divided by the base area
              </div>
            </div>
            ...
            <div className="quiz-question">
              ...
              <div className="correct-answer" style={{ marginTop: '0.5rem', color: '#22c55e', fontStyle: 'italic' }}>
                Correct Answer: C) The graph does not intersect the x-axis
              </div>
            </div>
            ...
            <div className="quiz-question">
              ...
              <div className="correct-answer" style={{ marginTop: '0.5rem', color: '#22c55e', fontStyle: 'italic' }}>
                Correct Answer: C) The lines have the same slope but different y-intercepts
              </div>
            </div>
          </div>
